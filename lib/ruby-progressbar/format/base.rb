    ...
    class Base
      ...
      def process(environment)
        ...
        non_bar_molecules.each do |molecule|
          if molecule.method_name.is_a? Array
        ...
        leftover_bar_length     = environment.instance_variable_get(:@length_calc).send(:length) - processed_string_length + placeholder_length
